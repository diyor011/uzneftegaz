...
export default function StaffhelpPage() {
  ...
  const getEvents = async () => {
    try {
      ...
      const events = Array.isArray(json.xodim)
        ? json.xodim
        : json.xodim || [];
  ...
  return (
    <div className="min-h-screen max-w-[90%] mx-auto px-6">
      <div className="flex items-center gap-2 mt-8 mb-12">
        ...
        <h2 className="text-4xl font-bold text-info">   {t("home.support")}</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-12">
        {loading ? (
          ...
          <p className="text-gray-500 col-span-full">Maʼlumot topilmadi.</p>
        ) : (
