...
const Documents = () => {
  ...
  const arr = [

    {
      ...
      number: "PF-123",
      date: "15.10.2025",
      description: "Yoshlar siyosatini yanada rivojlantirish chora-tadbirlari to'g'risida",
      fileSize: "2.5 MB",
      format: "PDF"
    },
    {
      ...
      number: "QM-456",
      date: "10.10.2025",
      description: "Sport-sog'lomlashtirish tadbirlarini tashkil etish tartib-qoidalari",
      fileSize: "1.8 MB",
      format: "PDF"
    },
    {
  ...
  return (
    <div className='mx-auto max-w-[90%] grid grid-cols-1 lg:grid-cols-2 gap-6 mt-12'>
      {arr.map(item => (
        <div key={item.id} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-l-4 border-orange-500">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">№ {item.number} • {item.date}</p>
              </div>
            </div>
