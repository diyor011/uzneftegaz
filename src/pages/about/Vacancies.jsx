...
const Vacancies = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formData.append("caption", `🧾 Yangi ariza!\n\n💼 Vakansiya: ${vacancyName}`);
  ...
  return (
    <div className="max-w-[90%] mx-auto">
      <div className="flex items-center gap-2 mt-16 mb-12">
        <img src={logo} alt="" />
              ...
              <dialog id="my_modal_1" className="modal backdrop-blur-sm">
                <div className="modal-box max-w-md bg-white rounded-2xl shadow-2xl p-0 overflow-hidden">
                  <div className="bg-info p-6 text-white relative">
                    ...
                    <h3 className="font-bold text-2xl mb-2">  {t("about.vacanciesModalSendResume")}</h3>
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    {t("about.vacanciesModalVacancyName")}
                      ...
                      <input
                        type="text"
                        placeholder={`${t("about.vacanciesExamplePosition")} `}
                        value={vacancyName}
